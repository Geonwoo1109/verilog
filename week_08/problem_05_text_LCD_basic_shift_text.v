        ...
        if (rst) {LCD_RS, LCD_RW, LCD_DATA} = 10'b1_1_0000_0000;
            ...
            case(state)
                ...
                LINE1:      // LCD line 1 (up, first line)
                    begin
                        case(cnt)
                            00: {LCD_RS, LCD_RW, LCD_DATA} = {2'b00, 1'b1, 3'b000, s_pos};  // 10'b0_0_1_000_0000;
                ...
                LINE2:      // LCD line 2 (down, second line)
                    begin
                        case(cnt)
                            00: {LCD_RS, LCD_RW, LCD_DATA} = {2'b00, 1'b1, 3'b100, s_pos};  // 10'b0_0_1100_0000;
