module watch(clk, rst, state, output_watch, set_btn, mode_ampm, world_dip);
    input clk, rst;
    input [1:0] state;
    ...
    input world_dip;        // 0: Korea(here), 1: Another country(not here)
    input [5:0] set_btn;
    
    output reg [31:0] output_watch;
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) output_watch <= 32'd0;
            ...
            output_watch <= {h_ten, h_one, m_ten, m_one, s_ten, s_one, ms_ten, ms_one};
        end
    end
